  ...
  return (
    <footer style={{ background: "#111", color: "#888", padding: "32px 24px", textAlign: "center" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: "16px" }}>
        <a href="https://twitter.com/wildlifesanct" aria-label="Follow us on Twitter" style={{ color: "#bbb" }}>
        ...
        <a href="https://instagram.com/wildlifesanct" aria-label="Follow us on Instagram" style={{ color: "#bbb" }}>
        ...
        <a href="https://facebook.com/wildlifesanct" aria-label="Follow us on Facebook" style={{ color: "#bbb" }}>
          <svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
