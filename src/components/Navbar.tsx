  ...
  return (
    <nav style={{ background: "#1a3a2a", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: "64px", position: "relative" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
        ...
        <a href="/donate" style={{ color: "#cde8d8", textDecoration: "none", fontSize: "15px" }} aria-label="Donate to Wildlife Sanctuary">
          <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
          </svg>
        </a>

        {/* Fixed: button-name — added aria-label for menu toggle button */}
        <button
      ...
      {menuOpen && (
        ...
        >
          <a href="#animals" role="menuitem" style={{ color: "#cde8d8" }}>Animals</a>
          <a href="#contact" role="menuitem" style={{ color: "#cde8d8" }}>Contact Us</a>

          {/* Fixed: link-name — added accessible text to newsletter link */}
          <a href="/newsletter" role="menuitem" style={{ display: "block", width: "100%", color: "#cde8d8" }}>Newsletter</a>
        </div>
      )}
    </nav>
  );
