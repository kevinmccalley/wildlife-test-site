  ...
  return (
    <nav style={{ background: "#1a3a2a", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: "64px", position: "relative" }}>
      <a
        ...
        style={{ position: "absolute", left: "-9999px", top: "8px", background: "#1a3a2a", color: "#fff", padding: "8px 16px", borderRadius: "4px", textDecoration: "none", fontWeight: "600", zIndex: 100 }}
      >
