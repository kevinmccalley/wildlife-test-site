  ...
  return (
    <section id="animals" style={{ padding: "80px 24px", background: "#f5f9f6" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <p style={{ textAlign: "center", color: "#1a5c36", fontSize: "16px", marginBottom: "24px" }}>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "20px" }}>
        ...
        <p style={{ color: "#1a5c36", fontSize: "14px", lineHeight: "1.6", marginBottom: "12px" }}>
          {animal.description}
        </p>

        <div style={{ background: "#f0f7f2", borderRadius: "8px", padding: "10px 12px", marginBottom: "16px" }}>
          <p style={{ fontSize: "13px", color: "#1a5c36", margin: 0 }}>
        ...
        <div style={{ display: "flex", gap: "8px" }}>
          <button
            ...
            aria-label={saved ? `Unsave ${animal.name}` : `Save ${animal.name}`}
            style={{
