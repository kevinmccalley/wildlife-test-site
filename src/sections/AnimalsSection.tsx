  ...
  return (
    <section id="animals" style={{ padding: "80px 24px", background: "#f5f9f6" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <p style={{ textAlign: "center", color: "#1e4d3a", fontSize: "16px", marginBottom: "24px" }}>
          Meet the remarkable species we work to protect every day.
        </p>

        {/* VIOLATION fixed: select-name — added <label> associated via htmlFor */}
        ...
        {/* VIOLATION fixed: label — added visually-hidden label for search input */}
...
function AnimalCard({ animal }: { animal: typeof ANIMALS[0] }) {
  ...
  return (
    ...
    >
      {/* VIOLATION fixed: image-alt — added descriptive alt text */}
      <img
      ...
      <div style={{ padding: "20px" }}>
        ...
        {/* VIOLATION fixed: color-contrast-enhanced — darkened text color for description */}
        <p style={{ color: "#1e4d3a", fontSize: "14px", lineHeight: "1.6", marginBottom: "12px" }}>
          {animal.description}
        </p>

        {/* VIOLATION fixed: color-contrast-enhanced — darkened text color for fact box */}
        ...
        <div style={{ display: "flex", gap: "8px" }}>
          {/* VIOLATION fixed: button-name — added aria-label to save/favourite button */}
          <button
          ...
          {/* VIOLATION fixed: color-contrast — darkened Learn More button background */}
          <a
            href={`#${animal.id}`}
            style={{
              flex: 1,
