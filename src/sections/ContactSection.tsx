      ...
      <div style={{ maxWidth: "640px", margin: "0 auto" }}>
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            {/* Fixed: added visually-hidden label for name input */}
            ...
            {/* Fixed: added visually-hidden label for email input */}
            ...
            {/* Fixed: added visually-hidden label for interest select */}
            ...
            {/* Fixed: added visually-hidden label for message textarea */}
