  ...
  return (
    <section id="contact" style={{ padding: "80px 24px", background: "#1a3a2a", color: "#fff" }}>
      <div style={{ maxWidth: "640px", margin: "0 auto" }}>
        ...
        {/* VIOLATION fixed: color-contrast-enhanced — lightened subtitle text */}
        <p style={{ color: "#d4eede", fontSize: "16px", textAlign: "center", marginBottom: "40px" }}>
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            {/* VIOLATION fixed: label — added visually-hidden label for name input */}
            ...
            {/* VIOLATION fixed: label — added visually-hidden label for email input */}
            ...
            {/* VIOLATION fixed: select-name — added visually-hidden label for interest select */}
            ...
            {/* VIOLATION fixed: frame-title — added title to iframe */}
            <div style={{ marginTop: "16px", borderRadius: "8px", overflow: "hidden" }}>
              {/* VIOLATION fixed: color-contrast-enhanced — lightened 'Find us here' text */}
              <p style={{ color: "#d4eede", fontSize: "14px", marginBottom: "8px" }}>Find us here:</p>
              <iframe
                src="https://www.openstreetmap.org/export/embed.html?bbox=-2.5%2C51.4%2C-2.3%2C51.5&amp;layer=mapnik"
                width="100%"
                height="200"
                title="Map showing Wildlife Sanctuary location in Bristol, UK"
